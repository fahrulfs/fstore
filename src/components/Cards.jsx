...
const Cards = ({ products }) => {
    return (
        ...
        <div className='container grid lg:grid-cols-4 grid-cols-2 lg:gap-5 gap-3 mt-8'>
            {products && products.length > 0 ? (
                products.map((item) => {
                    return (
                        <div key={item.id
                        } className='rounded-md border border-gray-200 p-2 hover:scale-105 duration-150 cursor-poinetr'>
